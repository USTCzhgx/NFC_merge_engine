...
//  or          {6th, 5th. 4th, 3rd, 2nd, 1st}

// i_len [23:0]
//    R/W data length (bytes) max 16k+2048
...
if(rst) begin
	is_nvddr2 <= 1'h0;                                                                                            
end else if(i_cmd_valid & o_cmd_ready & (i_cmd[7:0]==8'hEF) & (i_addr[7:0] == 8'h02)) begin
    is_nvddr2 <= 1'h1;                                                                            
...
if(rst) begin
    ...
    o0_cmd       <= i_cmd;  
    o0_cmd_id    <= i_cmd_id;                                                                
    o0_addr      <= i_addr[47:16]; // LBA to Flash Address                             
    o0_cmd_param <= {28'h0, 3'h4, 1'b0}; 
end else begin            
    o0_cmd_valid <= 1'h0;                                                                  
//    o0_addr      <= 24'h0;                              
//    o0_cmd_type  <= 2'h0;             
...
//            o1_data      <= 64'h0;        
//            o1_cmd_param <= {16'h0, 12'hc00,3'h4, 1'h1};
//        end
